...
export default class CarIndex extends Component {
  ...
  makeToggle = () => this.setState({makeOpen : !this.state.makeOpen})
  
  bodyToggle = () => this.setState({bodyOpen : !this.state.bodyOpen})
  
  colorToggle = () => this.setState({colorOpen : !this.state.colorOpen})
  
  yearToggle = () => this.setState({yearOpen : !this.state.yearOpen})
  
  priceToggle = () =>  this.setState({priceOpen : !this.state.priceOpen})
  
  mileToggle = () => this.setState({ mileOpen : !this.state.mileOpen})
  
  engineToggle = () => this.setState({engineOpen : !this.state.engineOpen})
  
  filterToggle = () =>this.setState({showFilter: !this.state.showFilter})
    ...
    render() {
        ...
        return (
          ...
          <Helmet>
            <title>HTM AUTO | Inventory</title>
